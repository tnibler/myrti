...
class VideoContentSetup {
  ...
  onContentLoad(e) {
    ...
    // video.dataset.shakaPlayer = "";
    const player = new shaka.Player(video);
    const ui = new shaka.ui.Overlay(player, videoContainer, video);
    content.element = videoContainer;
    // video.style = "width:100%;height:100%;"

    player.load(content.data.mpdManifestUrl).then(() => {
      console.log("manifest loaded", content.data.mpdManifestUrl);
    })
    // player.load("https://storage.googleapis.com/shaka-demo-assets/angel-one/dash.mpd").then(() => {
